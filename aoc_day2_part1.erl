...
next(N, u) when N == 1 orelse N == 2 orelse N == 3 -> N;
next(N, d) when N == 7 orelse N == 8 orelse N == 9 -> N;
next(N, l) when N == 1 orelse N == 4 orelse N == 7 -> N;
next(N, r) when N == 3 orelse N == 6 orelse N == 9 -> N;
